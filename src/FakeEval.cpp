...
static constexpr int16_t MG_VALUE[6] = { 82, 337, 365, 477, 1025, 12000};
static constexpr int16_t EG_VALUE[6] = { 94, 281, 297, 512,  936, 12000};

/* piece/sq tables
values from Rofchade: http://www.talkchess.com/forum3/viewtopic.php?f=2&t=68311&start=19
first index is A8, last index is H1 */

static int16_t MG_PAWN_TABLE[64] = {
     0,   0,   0,   0,   0,   0,  0,   0,
...
static int16_t EG_PAWN_TABLE[64] = {
      0,   0,   0,   0,   0,   0,   0,   0,
...
static int16_t MG_KNIGHT_TABLE[64] = {
...
static int16_t EG_KNIGHT_TABLE[64] = {
...
static int16_t MG_BISHOP_TABLE[64] = {
...
static int16_t EG_BISHOP_TABLE[64] = {
...
static int16_t MG_ROOK_TABLE[64] = {
...
static int16_t EG_ROOK_TABLE[64] = {
...
static int16_t MG_QUEEN_TABLE[64] = {
...
static int16_t EG_QUEEN_TABLE[64] = {
...
static int16_t MG_KING_TABLE[64] = {
...
static int16_t EG_KING_TABLE[64] = {
...
static constexpr int16_t* MG_TABLE[6] =
{
    MG_PAWN_TABLE,
    MG_KNIGHT_TABLE,
    MG_BISHOP_TABLE,
...
static constexpr int16_t* EG_TABLE[6] =
{
    EG_PAWN_TABLE,
    EG_KNIGHT_TABLE,
    EG_BISHOP_TABLE,
...
static constexpr uint8_t GAMEPHASE[12] = {0,0,1,1,1,1,2,2,4,4,0,0};
...
int16_t FakeEval::eval(const ChessBoard& board)
{
    int16_t mg[2] = {};
    int16_t eg[2] = {};
    int8_t phase = 0;
    ...
    // tapered eval
    int16_t mgScore = mg[to_int(Color::White)] - mg[to_int(Color::Black)];
